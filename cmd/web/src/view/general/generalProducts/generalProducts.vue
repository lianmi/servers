  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">                                
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增通用商品表</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="允许撤单" prop="allowCancel" width="120">
         <template slot-scope="scope">{{scope.row.allowCancel|formatBoolean}}</template>
    </el-table-column>
    
    <el-table-column label="详情图片1" prop="descPic1" width="120"></el-table-column> 
    
    <el-table-column label="详情图片2" prop="descPic2" width="120"></el-table-column> 
    
    <el-table-column label="详情图片3" prop="descPic3" width="120"></el-table-column> 
    
    <el-table-column label="详情图片4" prop="descPic4" width="120"></el-table-column> 
    
    <el-table-column label="详情图片5" prop="descPic5" width="120"></el-table-column> 
    
    <el-table-column label="descPic6字段" prop="descPic6" width="120"></el-table-column> 
    
    <el-table-column label="修改时间" prop="modifyAt" width="120"></el-table-column> 
    
    <el-table-column label="商品介绍" prop="productDesc" width="120"></el-table-column> 
    
    <el-table-column label="商品UUID" prop="productId" width="120"></el-table-column> 
    
    <el-table-column label="商品名称" prop="productName" width="120"></el-table-column> 
    
    <el-table-column label="商品大图1" prop="productPic1Large" width="120"></el-table-column> 
    
    <el-table-column label="商品大图2" prop="productPic2Large" width="120"></el-table-column> 
    
    <el-table-column label="商品大图3" prop="productPic3Large" width="120"></el-table-column> 
    
      <el-table-column label="商品类型" prop="productType" width="120">
        <template slot-scope="scope">
          {{filterDict(scope.row.productType,"int")}}
        </template>
      </el-table-column>
