...
func CreateApp(cf string) (*app.Application, error) {
	...
	application, err := orderservice.NewApp(orderserviceOptions, logger, kafkaClient)
	if err != nil {
		return nil, err
	}
...
var providerSet = wire.NewSet(log.ProviderSet, config.ProviderSet, database.ProviderSet, repositories.ProviderSet, consul.ProviderSet, jaeger.ProviderSet, redis.ProviderSet, kafkaBackend.ProviderSet, orderservice.ProviderSet)
