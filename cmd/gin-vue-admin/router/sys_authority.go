...
import (
	...
	"github.com/lianmi/servers/cmd/gin-vue-admin/nmi/servers/cmd/gin-vue-admin/api/v1"
	"github.com/lianmi/servers/cmd/gin-vue-admin/nmi/servers/cmd/gin-vue-admin/middleware"
)
