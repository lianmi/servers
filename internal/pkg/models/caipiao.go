...
type LotterySaleTime struct {
	...
	Holidays      string `json:"holidays" form:"holidays" gorm:"column:holidays;comment:;type:varchar(191);size:191;"`                                //节假日时间，用逗号隔开， 01-01,10-01,etc...
	IsActive      *bool  `json:"isActive" form:"isActive" gorm:"column:is_active;comment:;type:tinyint;"`                                             //是否激活, true-激活 ， false  - 不激活
}
