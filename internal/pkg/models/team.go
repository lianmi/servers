...
type TeamInfo struct {
	...
	Introductory string `gorm:"type:text;null" form:"introductory" json:"introductory,omitempty" ` //群简介

	//状态 Init(0) - 初始状态,未审核 Normal(1) - 正常状态 Blocked(2) - 封禁状态 disMiss(3)- 群被解散
