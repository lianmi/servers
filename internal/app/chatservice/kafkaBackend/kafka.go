...
func NewKafkaClient(o *KafkaOptions, db *gorm.DB, redisPool *redis.Pool, logger *zap.Logger) *KafkaClient {
	...
	kClient.handleFuncMap[randtool.UnionUint16ToUint32(5, 6)] = kClient.HandleSendCancelMsg //5-9 发送撤销消息
	kClient.handleFuncMap[randtool.UnionUint16ToUint32(5, 12)] = kClient.HandleGetOssToken  //5-12 获取阿里云OSS上传Token
