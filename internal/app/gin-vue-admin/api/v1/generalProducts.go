...
import (
	...
	"go.uber.org/zap"
	"github.com/lianmi/servers/internal/pkg/models" //采用一个入口创建
)
...
// @Param data body models.GeneralProduct true "创建GeneralProduct"
...
// @accept application/json
// @Produce application/json
// @Param data body models.GeneralProduct true "删除GeneralProduct"
...
// @accept application/json
// @Produce application/json
// @Param data body models.GeneralProduct true "更新GeneralProduct"
...
// @accept application/json
// @Produce application/json
// @Param data body models.GeneralProduct true "用id查询GeneralProduct"
