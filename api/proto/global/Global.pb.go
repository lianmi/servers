...
const (
	...
	FriendSubType_WatchRequest          FriendSubType = 9  //*< 关注商户
	FriendSubType_CancelWatchRequest    FriendSubType = 10 //*< 取消关注商户
...
const (
	...
	OrderSubType_OrderPayDoneEvent OrderSubType = 12 //*< 9-12. 支付订单完成的事件
)
...
const (
	...
	StoreType_ST_SuperStore        StoreType = 1  //大型超市
	StoreType_ST_Store             StoreType = 2  //普通超市, 往往离家很近，出门便到，一些日常用品、生活杂物往往不需要跑太远，这里都能买到。
	StoreType_ST_DiscountStore     StoreType = 3  //折扣店周转快，但相对的种类不齐全、经营面积、地段、装修等因素较一般，以此换得折扣竞争力。
	StoreType_ST_ConvenienceStore  StoreType = 4  //便利店 便利店同其名字一样，以满足客户应急性、便利性需求为目的，一般占据着离一方人士最近的地段，日经营日间长，但品种有限且固定。
	StoreType_ST_GroceryStore      StoreType = 5  //食杂店 粮油 生活清洁用品
	StoreType_ST_MeatStore         StoreType = 6  //肉类店
	StoreType_ST_FruitStore        StoreType = 7  //水果店
	StoreType_ST_CakeStore         StoreType = 8  //面包糕点店 蛋糕
	StoreType_ST_FucaiStore        StoreType = 9  //福彩彩票店
	StoreType_ST_TicaiStore        StoreType = 10 //体彩彩票店
	StoreType_ST_CarryStore        StoreType = 11 //物流搬运或载货出租车公司
	StoreType_ST_MaintenanceStore  StoreType = 12 //维修电器
	StoreType_ST_HouseKeepingStore StoreType = 13 //家政服务，电工，木工，泥水工，开锁，
	StoreType_ST_ServicesStore     StoreType = 14 //服务行业，会计
	StoreType_ST_WarehouseClub     StoreType = 15 //仓储会员店是一种带有批发性质的批售式商店，在我国又称为仓储式商场或货仓式商场。东西价格往往比超市更便宜，但位置一般较偏。
	StoreType_ST_VarietyStore      StoreType = 16 //百货店 百货店在同一较大场所会同时经营若干大类的商品，但实行统一的管理、分区销售，满足客户对商品多样化选择的需求。
	StoreType_ST_SpecialityStore   StoreType = 17 //专业店是专门经营某类商品的商店，包括五金店、建材店，专业店所售商品的种类较全，所以顾客的选择很方便。
	StoreType_ST_ExclusiveStore    StoreType = 18 //专卖店 专卖店是专门经营或授权经营某一主要品牌或厂家商品的实体店铺，专卖店主要用于满足消费者对品牌的选择与信任。
	StoreType_ST_MaterialsStore    StoreType = 19 //家居建材店 专门提供家居、建材类物品的商店业态，针对性强，订单量大是它的显著特点。
	StoreType_ST_Microbusiness     StoreType = 20 //微商
)
...
var (
	StoreType_name = map[int32]string{
		...
		10: "ST_TicaiStore",
		11: "ST_CarryStore",
		12: "ST_MaintenanceStore",
		13: "ST_HouseKeepingStore",
		14: "ST_ServicesStore",
		15: "ST_WarehouseClub",
		16: "ST_VarietyStore",
		17: "ST_SpecialityStore",
		18: "ST_ExclusiveStore",
		19: "ST_MaterialsStore",
		20: "ST_Microbusiness",
	}
	StoreType_value = map[string]int32{
		...
		"ST_TicaiStore":        10,
		"ST_CarryStore":        11,
		"ST_MaintenanceStore":  12,
		"ST_HouseKeepingStore": 13,
		"ST_ServicesStore":     14,
		"ST_WarehouseClub":     15,
		"ST_VarietyStore":      16,
		"ST_SpecialityStore":   17,
		"ST_ExclusiveStore":    18,
		"ST_MaterialsStore":    19,
		"ST_Microbusiness":     20,
	}
)
...
const (
	...
	ProductType_OT_HouseKeeping ProductType = 7  //*< 家政
	ProductType_OT_Lottery      ProductType = 8  //*< 彩票
	ProductType_OT_Carry        ProductType = 9  //*< 搬运
	ProductType_OT_Maintenance  ProductType = 10 //*< 维修
	ProductType_OT_Services     ProductType = 11 //*< 服务行业
	ProductType_OT_Others       ProductType = 12 //*<其它
)
...
var file_api_proto_global_Global_proto_rawDesc = []byte{
	...
	0x10, 0x07, 0x2a, 0x89, 0x02, 0x0a, 0x0d, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x53, 0x75, 0x62,
	...
	0x12, 0x10, 0x0a, 0x0c, 0x57, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x10, 0x09, 0x12, 0x16, 0x0a, 0x12, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x57, 0x61, 0x74, 0x63,
	0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x10, 0x0a, 0x12, 0x12, 0x0a, 0x0e, 0x53, 0x79,
	...
	0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x10, 0x09, 0x2a, 0xc4, 0x01, 0x0a, 0x0c, 0x4f, 0x72, 0x64,
	...
	,
	...
	0x5f, 0x4d, 0x61, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x63, 0x65, 0x10, 0x0a, 0x12, 0x0f,
	0x0a, 0x0b, 0x4f, 0x54, 0x5f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x10, 0x0b, 0x12,
	0x0d, 0x0a, 0x09, 0x4f, 0x54, 0x5f, 0x4f, 0x74, 0x68, 0x65, 0x72, 0x73, 0x10, 0x0c, 0x2a, 0x55,
	...
	,
	...
	0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x62,
...
var file_api_proto_global_Global_proto_goTypes = []interface{}{
	...
	(TransactionType)(0),       // 13: cloud.lianmi.im.global.TransactionType
	(OrderType)(0),             // 14: cloud.lianmi.im.global.OrderType
	(ThirdPartyPaymentType)(0), // 15: cloud.lianmi.im.global.ThirdPartyPaymentType
	(DepositRecharge)(0),       // 16: cloud.lianmi.im.global.DepositRecharge
	(CustomerServiceType)(0),   // 17: cloud.lianmi.im.global.CustomerServiceType
}
