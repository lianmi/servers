...
type SyncReq struct {
	...
	//会话最大确认时间戳，触发同步会话最大确认时间事件
	//是否必填-是
	ConversationAckAt uint64 `protobuf:"fixed64,5,opt,name=conversationAckAt,proto3" json:"conversationAckAt,omitempty"`
	//标签最后同步时间戳，触发同步用户标签列表事件
	//是否必填-是
	TagsAt uint64 `protobuf:"fixed64,6,opt,name=tagsAt,proto3" json:"tagsAt,omitempty"`
	//系统消息最后同步时间戳，触发同步系统离线消息事件
	//是否必填-是
	SystemMsgAt uint64 `protobuf:"fixed64,7,opt,name=systemMsgAt,proto3" json:"systemMsgAt,omitempty"`
}
...
func (x *SyncReq) GetConversationAckAt() uint64 {
	if x != nil {
		return x.ConversationAckAt
	}
	return 0
}
...
var file_api_proto_syn_Sync_proto_rawDesc = []byte{
	...
	,
...
var file_api_proto_syn_Sync_proto_goTypes = []interface{}{
	(*SyncReq)(nil), // 0: cc.lianmi.im.syn.SyncReq
	(*SyncRsp)(nil), // 1: cc.lianmi.im.syn.SyncRsp
}
