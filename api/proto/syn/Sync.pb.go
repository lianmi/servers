...
type SyncEventReq struct {
	...
	//用户关注商户的同步事件
	//是否必填-是
	WatchAt uint64 `protobuf:"fixed64,6,opt,name=watchAt,proto3" json:"watchAt,omitempty"`
	//系统公告同步事件
	//是否必填-是
	SysmtemMsgAt uint64 `protobuf:"fixed64,7,opt,name=sysmtemMsgAt,proto3" json:"sysmtemMsgAt,omitempty"`
}
...
func (x *SyncEventReq) GetSysmtemMsgAt() uint64 {
	if x != nil {
		return x.SysmtemMsgAt
	}
	return 0
}
...
var file_api_proto_syn_Sync_proto_rawDesc = []byte{
	...
	0xde, 0x01, 0x0a, 0x0c, 0x53, 0x79, 0x6e, 0x63, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71,
	...
	0x41, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x77, 0x61, 0x74, 0x63, 0x68, 0x41, 0x74, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x06, 0x52, 0x07, 0x77, 0x61, 0x74, 0x63, 0x68, 0x41, 0x74, 0x12, 0x22, 0x0a, 0x0c,
	0x73, 0x79, 0x73, 0x6d, 0x74, 0x65, 0x6d, 0x4d, 0x73, 0x67, 0x41, 0x74, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x06, 0x52, 0x0c, 0x73, 0x79, 0x73, 0x6d, 0x74, 0x65, 0x6d, 0x4d, 0x73, 0x67, 0x41, 0x74,
	0x22, 0x0e, 0x0a, 0x0c, 0x53, 0x79, 0x6e, 0x63, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x73, 0x70,
	...
	0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x79, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
