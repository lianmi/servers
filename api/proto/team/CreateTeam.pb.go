...
type Tmember struct {
	...
	Invitedusername string `protobuf:"bytes,3,opt,name=invitedusername,proto3" json:"invitedusername,omitempty"`
	// 用户本来的昵称
	Nick string `protobuf:"bytes,4,opt,name=nick,proto3" json:"nick,omitempty"`
	//群昵称
	AliasName string `protobuf:"bytes,5,opt,name=aliasName,proto3" json:"aliasName,omitempty"`
	//群成员头像
	...
	//成员类型
	//是否必须-是
	Type TeamMemberType `protobuf:"varint,9,opt,name=type,proto3,enum=cloud.lianmi.im.team.TeamMemberType" json:"type,omitempty"`
	//群消息通知方式
	NotifyType NotifyType `protobuf:"varint,10,opt,name=notifyType,proto3,enum=cloud.lianmi.im.team.NotifyType" json:"notifyType,omitempty"`
	//是否被禁言
	...
	//入群时间，unix时间戳
	JoinTime uint64 `protobuf:"fixed64,13,opt,name=joinTime,proto3" json:"joinTime,omitempty"`
	//最近更新时间，unix时间戳
	UpdateTime uint64 `protobuf:"fixed64,14,opt,name=updateTime,proto3" json:"updateTime,omitempty"`
}
...
func (x *Tmember) GetInvitedusername() string {
	if x != nil {
...
func (x *Tmember) GetAliasName() string {
	if x != nil {
		return x.AliasName
	}
	return ""
...
func (x *Tmember) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
var file_api_proto_team_CreateTeam_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x93, 0x02, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x61, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a, 0x08,
	0x74, 0x65, 0x61, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x74, 0x65, 0x61, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x40, 0x0a, 0x0a, 0x76, 0x65, 0x72, 0x69,
	0x66, 0x79, 0x54, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x63,
	...
	0x76, 0x65, 0x72, 0x69, 0x66, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x40, 0x0a, 0x0a, 0x69, 0x6e,
	0x76, 0x69, 0x74, 0x65, 0x4d, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20,
	...
	,
	...
	,
	...
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x74, 0x65, 0x61, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
