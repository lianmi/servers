...
type Team struct {
	...
	//群类型,枚举类型
	//是否必须:是
	Type TeamType `protobuf:"varint,8,opt,name=type,proto3,enum=cc.lianmi.im.team.TeamType" json:"type,omitempty"`
	//成员上限
	//是否必须：是
	...
	//群状态
	//是否必须：是
	Status Status `protobuf:"varint,11,opt,name=status,proto3,enum=cc.lianmi.im.team.Status" json:"status,omitempty"`
	//校验模式
	//是否必须：是
	VerifyType VerifyType `protobuf:"varint,12,opt,name=verifyType,proto3,enum=cc.lianmi.im.team.VerifyType" json:"verifyType,omitempty"`
	//发言方式
	//是否必须：是
	MuteType MuteMode `protobuf:"varint,13,opt,name=muteType,proto3,enum=cc.lianmi.im.team.MuteMode" json:"muteType,omitempty"`
	//邀请模式
	//是否必须：是
	InviteMode InviteMode `protobuf:"varint,14,opt,name=inviteMode,proto3,enum=cc.lianmi.im.team.InviteMode" json:"inviteMode,omitempty"`
	//群资料修改模式：谁可以修改群资料
	//是否必须：是
	UpdateTeamMode UpdateMode `protobuf:"varint,15,opt,name=updateTeamMode,proto3,enum=cc.lianmi.im.team.UpdateMode" json:"updateTeamMode,omitempty"`
	//JSON扩展字段,由业务方解析
	//是否必填-否
...
type TeamMemberGet struct {
	...
	//成员类型
	//是否必须-是
	Type TeamMemberType `protobuf:"varint,6,opt,name=type,proto3,enum=cc.lianmi.im.team.TeamMemberType" json:"type,omitempty"`
	//群消息通知方式
	//是否必须-是
	NotifyType NotifyType `protobuf:"varint,7,opt,name=notifyType,proto3,enum=cc.lianmi.im.team.NotifyType" json:"notifyType,omitempty"`
	//是否被禁言
	//是否必须-是
...
var file_api_proto_team_Team_proto_rawDesc = []byte{
	...
	0x2f, 0x54, 0x65, 0x61, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x63, 0x63, 0x2e,
	0x6c, 0x69, 0x61, 0x6e, 0x6d, 0x69, 0x2e, 0x69, 0x6d, 0x2e, 0x74, 0x65, 0x61, 0x6d, 0x22, 0xcc,
	0x05, 0x0a, 0x04, 0x54, 0x65, 0x61, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x65, 0x61, 0x6d, 0x49,
	...
	0x09, 0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12, 0x22, 0x0a, 0x0c, 0x61, 0x6e, 0x6e, 0x6f, 0x75,
	0x6e, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x61,
	0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x69,
	...
	,
	...
	,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x35, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x63, 0x63, 0x2e, 0x6c, 0x69, 0x61, 0x6e, 0x6d, 0x69, 0x2e,
	0x69, 0x6d, 0x2e, 0x74, 0x65, 0x61, 0x6d, 0x2e, 0x54, 0x65, 0x61, 0x6d, 0x4d, 0x65, 0x6d, 0x62,
	0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x3d, 0x0a, 0x0a,
	0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x54, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x1d, 0x2e, 0x63, 0x63, 0x2e, 0x6c, 0x69, 0x61, 0x6e, 0x6d, 0x69, 0x2e, 0x69, 0x6d, 0x2e,
	...
	,
...
var file_api_proto_team_Team_proto_goTypes = []interface{}{
	(TeamType)(0),             // 0: cc.lianmi.im.team.TeamType
	(TribeMemberQueryType)(0), // 1: cc.lianmi.im.team.TribeMemberQueryType
	(Status)(0),               // 2: cc.lianmi.im.team.Status
	(VerifyType)(0),           // 3: cc.lianmi.im.team.VerifyType
	(MuteMode)(0),             // 4: cc.lianmi.im.team.MuteMode
	(BeInviteMode)(0),         // 5: cc.lianmi.im.team.BeInviteMode
	(InviteMode)(0),           // 6: cc.lianmi.im.team.InviteMode
	(UpdateMode)(0),           // 7: cc.lianmi.im.team.UpdateMode
	(NotifyType)(0),           // 8: cc.lianmi.im.team.NotifyType
	(TeamMemberType)(0),       // 9: cc.lianmi.im.team.TeamMemberType
	(TeamField)(0),            // 10: cc.lianmi.im.team.TeamField
	(MemberStatus)(0),         // 11: cc.lianmi.im.team.MemberStatus
	(*Team)(nil),              // 12: cc.lianmi.im.team.Team
	(*TeamMemberGet)(nil),     // 13: cc.lianmi.im.team.TeamMemberGet
}
var file_api_proto_team_Team_proto_depIdxs = []int32{
	0, // 0: cc.lianmi.im.team.Team.type:type_name -> cc.lianmi.im.team.TeamType
	2, // 1: cc.lianmi.im.team.Team.status:type_name -> cc.lianmi.im.team.Status
	3, // 2: cc.lianmi.im.team.Team.verifyType:type_name -> cc.lianmi.im.team.VerifyType
	4, // 3: cc.lianmi.im.team.Team.muteType:type_name -> cc.lianmi.im.team.MuteMode
	6, // 4: cc.lianmi.im.team.Team.inviteMode:type_name -> cc.lianmi.im.team.InviteMode
	7, // 5: cc.lianmi.im.team.Team.updateTeamMode:type_name -> cc.lianmi.im.team.UpdateMode
	9, // 6: cc.lianmi.im.team.TeamMemberGet.type:type_name -> cc.lianmi.im.team.TeamMemberType
	8, // 7: cc.lianmi.im.team.TeamMemberGet.notifyType:type_name -> cc.lianmi.im.team.NotifyType
