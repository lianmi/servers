...
type Store struct {
	...
	Longitude             float64          `protobuf:"fixed64,20,opt,name=longitude,proto3" json:"longitude,omitempty"`                                     //商户地址的经度
	Latitude              float64          `protobuf:"fixed64,21,opt,name=latitude,proto3" json:"latitude,omitempty"`                                       //商户地址的纬度
...
var file_api_proto_user_Store_proto_rawDesc = []byte{
	...
	0x14, 0x20, 0x01, 0x28, 0x01, 0x52, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65,
