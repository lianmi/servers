...
func (x *SyncTagsEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncTagsEvent) ProtoMessage() {}

func (x *SyncTagsEvent) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_user_SyncTagsEvent_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncTagsEvent.ProtoReflect.Descriptor instead.
func (*SyncTagsEvent) Descriptor() ([]byte, []int) {
	return file_api_proto_user_SyncTagsEvent_proto_rawDescGZIP(), []int{1}
}

func (x *SyncTagsEvent) GetAddTags() []*Tag {
	if x != nil {
		return x.AddTags
	}
	return nil
...
func (x *SyncTagsEvent) GetRemovedTags() []*Tag {
	if x != nil {
...
func (x *SyncTagsEvent) GetTimeTag() uint64 {
	if x != nil {
		return x.TimeTag
	}
	return 0
...
var file_api_proto_user_SyncTagsEvent_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x1a, 0x1c, 0x61, 0x70, 0x69, 0x2f, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x4d, 0x61, 0x72, 0x6b, 0x54, 0x61, 0x67, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x53, 0x0a, 0x03, 0x54, 0x61, 0x67, 0x12, 0x18, 0x0a, 0x07,
	...
	,
...
var file_api_proto_user_SyncTagsEvent_proto_goTypes = []interface{}{
	(*Tag)(nil),           // 0: cc.lianmi.im.user.Tag
	(*SyncTagsEvent)(nil), // 1: cc.lianmi.im.user.SyncTagsEvent
	(MarkTagType)(0),      // 2: cc.lianmi.im.user.MarkTagType
}
var file_api_proto_user_SyncTagsEvent_proto_depIdxs = []int32{
	2, // 0: cc.lianmi.im.user.Tag.type:type_name -> cc.lianmi.im.user.MarkTagType
	0, // 1: cc.lianmi.im.user.SyncTagsEvent.addTags:type_name -> cc.lianmi.im.user.Tag
	0, // 2: cc.lianmi.im.user.SyncTagsEvent.removedTags:type_name -> cc.lianmi.im.user.Tag
