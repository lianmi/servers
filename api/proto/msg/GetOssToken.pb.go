...
type GetOssTokenRsp struct {
	...
	//token有效时长(单位S)
	Expire uint64 `protobuf:"fixed64,8,opt,name=expire,proto3" json:"expire,omitempty"`
	//服务器按json格式组装
...
func (x *GetOssTokenRsp) GetExpiration() string {
	if x != nil {
		return x.Expiration
	}
	return ""
...
var file_api_proto_msg_GetOssToken_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x22, 0xb0, 0x02, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4f, 0x73,
	...
	0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63,
	...
	0x08, 0x20, 0x01, 0x28, 0x06, 0x52, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x12, 0x1a, 0x0a,
	0x08, 0x63, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52,
