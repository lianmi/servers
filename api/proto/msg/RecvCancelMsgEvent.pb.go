...
//接收撤销消息事件
type RecvCancelMsgEvent struct {
	...
	//是否必填-是
	FromSessionId string `protobuf:"bytes,1,opt,name=fromSessionId,proto3" json:"fromSessionId,omitempty"`
	//被撤销的消息接收方对应的sessionId
	//完整格式 联系人ID.Scene.设备ID
	//如 toTeamId.C2G
	//是否必填-否
	ToSessionId string `protobuf:"bytes,2,opt,name=toSessionId,proto3" json:"toSessionId,omitempty"`
	//要撤销的消息的由服务器分配的消息id
	//是否必填-是
	IdServer string `protobuf:"bytes,3,opt,name=idServer,proto3" json:"idServer,omitempty"`
}

func (x *RecvCancelMsgEvent) Reset() {
	*x = RecvCancelMsgEvent{}
...
func (x *RecvCancelMsgEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RecvCancelMsgEvent) ProtoMessage() {}

func (x *RecvCancelMsgEvent) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msg_RecvCancelMsgEvent_proto_msgTypes[0]
...
// Deprecated: Use RecvCancelMsgEvent.ProtoReflect.Descriptor instead.
func (*RecvCancelMsgEvent) Descriptor() ([]byte, []int) {
	return file_api_proto_msg_RecvCancelMsgEvent_proto_rawDescGZIP(), []int{0}
}

func (x *RecvCancelMsgEvent) GetFromSessionId() string {
	if x != nil {
...
func (x *RecvCancelMsgEvent) GetToSessionId() string {
	if x != nil {
...
func (x *RecvCancelMsgEvent) GetIdServer() string {
	if x != nil {
		return x.IdServer
	}
	return ""
...
var file_api_proto_msg_RecvCancelMsgEvent_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x61, 0x6e, 0x6d, 0x69, 0x2e, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x22, 0x78, 0x0a,
	0x12, 0x52, 0x65, 0x63, 0x76, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x4d, 0x73, 0x67, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x12, 0x24, 0x0a, 0x0d, 0x66, 0x72, 0x6f, 0x6d, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x66, 0x72, 0x6f, 0x6d,
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x74, 0x6f, 0x53,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	...
	0x64, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_api_proto_msg_RecvCancelMsgEvent_proto_goTypes = []interface{}{
	(*RecvCancelMsgEvent)(nil), // 0: cloud.lianmi.im.msg.RecvCancelMsgEvent
}
...
func file_api_proto_msg_RecvCancelMsgEvent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_proto_msg_RecvCancelMsgEvent_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RecvCancelMsgEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
